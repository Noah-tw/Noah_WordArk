// engine_mascot.js — optional ambient mascot controller.
...
`;
  ...
  function loadMarkup(character){
    if(character.inline) return Promise.resolve(character.inline);
  ...
  window.Mascot = {
    ...
    refreshHost(){
      ...
      if(!found || found===host) return Promise.resolve(currentCharacter);
      host=found;
